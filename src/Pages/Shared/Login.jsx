      ...
      <div className="hero-content flex-col gap-20 lg:flex-row">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm border-2 border-[#D0D0D0] bg-base-100">
          <form onSubmit={handleForm} className="card-body mb-0 pb-0">
            <h1 className="text-4xl text-[#444] text-center font-semibold">
              Login
            </h1>
            <div className="form-control">
              <label className="label">
                <span className="label-text text-[#444] text-lg font-semibold">
                  Email
                </span>
              </label>
              <input
            ...
            <p className="text-[#737373] mb-6 text-lg text-center">
              Have You New Her?{" "}
